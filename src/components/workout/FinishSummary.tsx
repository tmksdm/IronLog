// src/components/workout/FinishSummary.tsx

/**
 * Post-finish summary for a strength workout.
 * Shows duration, tonnage, exercise counts and a body-weight-after input.
 * No cardio / pull-ups here — those are standalone activities now (Stage 4).
 */
...
export default function FinishSummary({ onFinish, isSaving }: FinishSummaryProps) {
