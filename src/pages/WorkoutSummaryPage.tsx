  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#121212]">
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-8">
        ...
        <button
          onClick={() => navigate('/', { replace: true })}
          className="w-full mt-6 mb-4 py-4 rounded-xl bg-[#4CAF50] text-white font-semibold text-base active:bg-[#388E3C] transition-colors flex items-center justify-center gap-2"
        >
          <Home size={20} />
          На главную
        </button>
