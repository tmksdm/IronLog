...
- На текущей машине нет `winget`. Не пытаться устанавливать GitHub CLI и не использовать браузер для запуска Actions; готовый portable CLI находится в `D:\Pr\StepJokes\.tooling\github-cli\bin\gh.exe`.
